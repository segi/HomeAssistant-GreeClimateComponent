...
class GreeClimate(ClimateEntity):
    ...
    async def SendStateToAc(self):
        opt_list = ["Pow", "Mod", "SetTem", "WdSpd", "Air", "Blo", "SwhSlp", "SwingLfRig", "SwUpDn", "Quiet", "Tur", "TemUn", "HeatCoolType", "TemRec", "SvSt", "SlpMod"]  # PATCHED: some Gree firmwares drop the whole command if an unsupported opt key is present (Health/Lig/StHt/AntiDirectBlow/LigSen + buzzer keys)
